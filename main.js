...
const PROJECTS = [
  ...
  { title: 'Dr. Hajili', desc: 'Informational website and booking platform for an aesthetic surgeon, featuring professional services and appointment scheduling.', tech: ['Laravel', 'PHP', 'MySQL', 'JavaScript'], image: 'assets/projects/drhajili.png', github: '#', demo: 'https://drhajili.de' },
  { title: 'Sulama', desc: 'An specialized agricultural and landscape platform offering automated irrigation systems, equipment showcase, and corporate services.', tech: ['Laravel', 'PHP', 'MySQL', 'JavaScript'], image: 'assets/projects/sulama.png', github: '#', demo: 'https://sulama.az/' },
